public class Main {
    ...
    public static void main(String[] args) {
        ...
        double xa1 = Math.toRadians(25);
        double ya1 = Math.toRadians(15);
        double xb1 = Math.toRadians(23);
        double yb1 = Math.toRadians(20);

        double xa2 = Math.toRadians(23);
        double ya2 = Math.toRadians(20);
        double xb2 = Math.toRadians(21);
        double yb2 = Math.toRadians(24);

        double xa3 = Math.toRadians(21);
        double ya3 = Math.toRadians(24);
        double xb3 = Math.toRadians(20);
        double yb3 = Math.toRadians(27);

        double xa4 = Math.toRadians(20);
        double ya4 = Math.toRadians(27);
        double xb4 = Math.toRadians(19);
        double yb4 = Math.toRadians(35);

        double xa5 = Math.toRadians(19);
        double ya5 = Math.toRadians(35);
        double xb5 = Math.toRadians(21);
        double yb5 = Math.toRadians(46);

        double xa6 = Math.toRadians(21);
        double ya6 = Math.toRadians(46);
        double xb6 = Math.toRadians(23);
        double yb6 = Math.toRadians(56);

        double xa7 = Math.toRadians(23);
        double ya7 = Math.toRadians(56);
        double xb7 = Math.toRadians(25);
        double yb7 = Math.toRadians(65);

        double xa8 = Math.toRadians(25);
        double ya8 = Math.toRadians(65);
        double xb8 = Math.toRadians(28);
        double yb8 = Math.toRadians(70);

        double xa9 = Math.toRadians(28);
        double ya9 = Math.toRadians(70);
        double xb9 = Math.toRadians(32);
        double yb9 = Math.toRadians(73);

        double xa10 = Math.toRadians(32);
        double ya10 = Math.toRadians(73);
        double xb10 = Math.toRadians(34);
        double yb10 = Math.toRadians(74);

        double xa11 = Math.toRadians(34);
        double ya11 = Math.toRadians(74);
        double xb11 = Math.toRadians(36);
        double yb11 = Math.toRadians(74);

        double xa12 = Math.toRadians(36);
        double ya12 = Math.toRadians(74);
        double xb12 = Math.toRadians(39);
        double yb12 = Math.toRadians(74);
        ...
        double c2 = 2*Math.atan2(Math.sqrt(a2),Math.sqrt(1-a));
        ...
        double c8 = 2*Math.atan2(Math.sqrt(a8),Math.sqrt(1-a8));
        ...
        double c9 = 2*Math.atan2(Math.sqrt(a9),Math.sqrt(1-a9));
        ...
        double c12 = 2*Math.atan2(Math.sqrt(a12),Math.sqrt(1-a12));
        double distance12 = 6371*c12;

        System.out.println("Day 1 Distance:"+distance1);
        System.out.println("Day 2 Distance:"+distance2);
        System.out.println("Day 3 Distance:"+distance3);
        System.out.println("Day 4 Distance:"+distance4);
        System.out.println("Day 5 Distance:"+distance5);
        System.out.println("Day 6 Distance:"+distance6);
        System.out.println("Day 7 Distance:"+distance7);
        System.out.println("Day 8 Distance:"+distance8);
        System.out.println("Day 9 Distance:"+distance9);
        System.out.println("Day 10 Distance:"+distance10);
        System.out.println("Day 11 Distance:"+distance11);
        System.out.println("Day 12 Distance:"+distance12);
